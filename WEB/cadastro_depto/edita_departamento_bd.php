...
if($erro == "")
{
   ...
   $consulta="update departamento set sigla='$sigla', descricao='$descricao', cod_chefe='$chefe' where id='$id'"; 
   $resultado = mysql_query($consulta,$conexao); 
   if($resultado)
	{
		$mensagem = "Edi&ccedil;&atilde;o realizada com Sucesso."; 
		$mensagem = urlencode($mensagem);
		$url = "sucesso.php?mensagem=$mensagem&url=cadastro_departamento.php";
	}
	else
	{
		$erro = "Erro ao editar o cadastro.";
		$erro = urlencode($erro);
